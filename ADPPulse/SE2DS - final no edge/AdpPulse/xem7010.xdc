...
#ADP Project Pins
#set_property PACKAGE_PIN P6 [get_ports {quench_p}]
#set_property PACKAGE_PIN N5 [get_ports {quench_n}]
#MC1 67
set_property PACKAGE_PIN C14 [get_ports {quench_p}] 
#MC1 69 
set_property PACKAGE_PIN C15 [get_ports {quench_n}]  
set_property IOSTANDARD LVCMOS33 [get_ports {quench_p}]
set_property IOSTANDARD LVCMOS33 [get_ports {quench_n}]
#set_property IOSTANDARD LVDS_25 [get_ports {quench_p}]
#set_property IOSTANDARD LVDS_25 [get_ports {quench_n}]
#set_property DIFF_TERM TRUE [get_ports {quench_p}];


set_property PACKAGE_PIN N4 [get_ports {q_reset_wire}]
set_property IOSTANDARD LVCMOS33 [get_ports {q_reset_wire}]



set_property PACKAGE_PIN H4 [get_ports {apd_p}]
set_property PACKAGE_PIN G4 [get_ports {apd_n}]
set_property IOSTANDARD LVDS_25 [get_ports {apd_p}]
set_property IOSTANDARD LVDS_25 [get_ports {apd_n}]



#Optional Pins
set_property PACKAGE_PIN M6 [get_ports {apd_led}]
set_property IOSTANDARD LVCMOS33 [get_ports {apd_led}]

set_property PACKAGE_PIN M3 [get_ports {quench_led}]
set_property IOSTANDARD LVCMOS33 [get_ports {quench_led}]

set_property PACKAGE_PIN L5 [get_ports {q_reset_led}]
set_property IOSTANDARD LVCMOS33 [get_ports {q_reset_led}]
